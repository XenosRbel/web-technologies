                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center card-product">
                                        <div class="card-product__img">
                                            <img class="card-img" src="{{url('/images/' . $product->image)}}" alt="">
                                            <ul class="card-product__imgOverlay">
                                                <li>
                                                    <button><i class="ti-search"></i></button>
                                                </li>
                                                <li onclick="addtocard({{$product}})">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var isSuccess = document.getElementById('success')
        if (isSuccess) {
    ...
    function addtocard(product) {
        ...
        var orderCount = localStorage.getItem('orders') ? JSON.parse(localStorage.getItem('orders')).length : 0;
        $('.nav-shop__circle').text(orderCount)
    }
</script>
